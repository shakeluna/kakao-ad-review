...
const I18n = (() => {
  const T = {
    ko: {
      ...
      'filter.pass': 'Pass',
      'filter.fail': 'Fail',
      'progress.upload': 'Google Sheets에서 데이터를 로드합니다',
      ...
      'quickFail.title': '빠른 Fail',
      'hint.nav': '<kbd>P</kbd> Pass &nbsp; <kbd>F</kbd> Fail &nbsp; <kbd>←</kbd><kbd>→</kbd> 이동 &nbsp; <kbd>Z/X/C/V/B/N/M</kbd> 빠른Fail',
      'hint.passReason': '<kbd>1-2</kbd> 이미지 &nbsp; <kbd>5-8</kbd> 업종 &nbsp; <kbd>9</kbd> AI동의 &nbsp; <kbd>→</kbd><kbd>Enter</kbd> 저장+다음 &nbsp; <kbd>Esc</kbd> 취소 &nbsp; <kbd>Z/X/C/V/B/N/M</kbd> 빠른Fail',
      'hint.failReason': '<kbd>1-7</kbd> 이미지 &nbsp; <kbd>Q-U</kbd> 업종 &nbsp; <kbd>0</kbd> AI동의 &nbsp; <kbd>→</kbd><kbd>Enter</kbd> 저장+다음 &nbsp; <kbd>Esc</kbd> 취소 &nbsp; <kbd>Z/X/C/V/B/N/M</kbd> 빠른Fail',
      ...
      'btn.refresh': '새로고침',
      'btn.forceSync': '강제 업데이트',
      'toast.forceSyncing': '시트에서 강제 동기화 중...',
      'auth.title': '접근 제한',
    ...
    en: {
      ...
      'filter.pass': 'Pass',
      'filter.fail': 'Fail',
      'progress.upload': 'Loading data from Google Sheets',
      ...
      'quickFail.title': 'Quick Fail',
      'hint.nav': '<kbd>P</kbd> Pass &nbsp; <kbd>F</kbd> Fail &nbsp; <kbd>←</kbd><kbd>→</kbd> Move &nbsp; <kbd>Z/X/C/V/B/N/M</kbd> Quick Fail',
      'hint.passReason': '<kbd>1-2</kbd> Image &nbsp; <kbd>5-8</kbd> Vertical &nbsp; <kbd>9</kbd> AI Agree &nbsp; <kbd>→</kbd><kbd>Enter</kbd> Save+Next &nbsp; <kbd>Esc</kbd> Cancel &nbsp; <kbd>Z/X/C/V/B/N/M</kbd> Quick Fail',
      'hint.failReason': '<kbd>1-7</kbd> Image &nbsp; <kbd>Q-U</kbd> Vertical &nbsp; <kbd>0</kbd> AI Agree &nbsp; <kbd>→</kbd><kbd>Enter</kbd> Save+Next &nbsp; <kbd>Esc</kbd> Cancel &nbsp; <kbd>Z/X/C/V/B/N/M</kbd> Quick Fail',
      ...
      'toast.forceSyncing': 'Force syncing from Sheets...',
