...
const I18n = (() => {
  const T = {
    ko: {
      ...
      'hint.nav': '<kbd>P</kbd> Pass &nbsp; <kbd>F</kbd> Fail &nbsp; <kbd>S</kbd> Skip &nbsp; <kbd>←</kbd><kbd>→</kbd> 이동',
      'hint.passReason': '<kbd>1-2</kbd> 이미지 &nbsp; <kbd>5-8</kbd> 업종 &nbsp; <kbd>9</kbd> AI동의 &nbsp; <kbd>→</kbd><kbd>Enter</kbd> 저장+다음 &nbsp; <kbd>Esc</kbd> 취소',
      'hint.failReason': '<kbd>1-7</kbd> 이미지 &nbsp; <kbd>Q-U</kbd> 업종 &nbsp; <kbd>0</kbd> AI동의 &nbsp; <kbd>→</kbd><kbd>Enter</kbd> 저장+다음 &nbsp; <kbd>Esc</kbd> 취소',
    ...
    en: {
      ...
      'hint.nav': '<kbd>P</kbd> Pass &nbsp; <kbd>F</kbd> Fail &nbsp; <kbd>S</kbd> Skip &nbsp; <kbd>←</kbd><kbd>→</kbd> Move',
      'hint.passReason': '<kbd>1-2</kbd> Image &nbsp; <kbd>5-8</kbd> Vertical &nbsp; <kbd>9</kbd> AI Agree &nbsp; <kbd>→</kbd><kbd>Enter</kbd> Save+Next &nbsp; <kbd>Esc</kbd> Cancel',
      'hint.failReason': '<kbd>1-7</kbd> Image &nbsp; <kbd>Q-U</kbd> Vertical &nbsp; <kbd>0</kbd> AI Agree &nbsp; <kbd>→</kbd><kbd>Enter</kbd> Save+Next &nbsp; <kbd>Esc</kbd> Cancel',
